...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form  action="<?php echo base_url()?>Admin/category/update_category" method="post">
                                    ...
                                    <tr id="">
                                        ...
                                        <td>
                                            <input dataid="<?php echo $veri->id ?>"
                                                   ...
                                                   type="checkbox"
                                                   data-toggle="toggle"
                                                   data-url="<?php echo base_url()?>Admin/category/isActive"
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo base_url()?>Admin/category/delete_category/<?php echo $veri->id ?> ">
