...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form  action="<?php echo base_url()?>Admin/room/update_room" method="post">
                    ...
                    <div class="box">
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <?php foreach($room as $veri) { ?>
                                    <tr id="">
                                        <td> <?php echo  $veri->id  ?> </td>
                                        <td><?php  echo $veri->title  ?></td>
                                        <td> <?php echo  $veri->detail  ?> </td>
                                        <td><?php  echo $veri->size  ?></td>
                                        <td> <?php echo  $veri->default_price?> </td>
                                        <td> <?php echo  $veri->room_type_id  ?> </td>
                                        <td>
                                            <input dataid="<?php echo $veri->id ?>"
                                                   ...
                                                   type="checkbox"
                                                   data-toggle="toggle"
                                                   data-url="<?php echo base_url()?>Admin/room/isActive"
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo base_url()?>Admin/room/delete_room/<?php echo $veri->id ?> ">
