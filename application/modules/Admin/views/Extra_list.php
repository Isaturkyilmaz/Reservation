...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form  action="<?php echo base_url()?>Admin/extra/update_extra" method="post">
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Extra
                <small>Extra Servisler</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Anasayfa</a></li>
                <li class="active">Oda İşlemleri</li>
                <li class="active">Extra Servis Listesi</li>
            </ol>
        </section>
                                    ...
                                    <tr id="">
                                        ...
                                        <td>
                                            <input dataid="<?php echo $veri->id ?>"
                                                   ...
                                                   type="checkbox"
                                                   data-toggle="toggle"
                                                   data-url="<?php echo base_url()?>Admin/extra/isActive"
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo base_url()?>Admin/category/delete_extra/<?php echo $veri->id ?> ">
